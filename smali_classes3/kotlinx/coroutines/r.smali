...
.field public static final U:Lkotlinx/coroutines/r;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lkotlinx/coroutines/r;->U:Lkotlinx/coroutines/r;
    ...
    .line 3
    invoke-static {v0}, Lk/j0/f;->j(Ljava/lang/String;)Ljava/lang/Integer;
    ...
    .line 7
    :goto_1
    sput v0, Lkotlinx/coroutines/r;->S:I
...
.method private final A()Ljava/util/concurrent/ExecutorService;
    ...
    .line 2
    invoke-direct {p0}, Lkotlinx/coroutines/r;->J()I
...
.method private final H()Ljava/util/concurrent/ExecutorService;
    ...
    invoke-direct {p0}, Lkotlinx/coroutines/r;->A()Ljava/util/concurrent/ExecutorService;
    ...
    .line 3
    sget-boolean v2, Lkotlinx/coroutines/r;->T:Z

    const/4 v3, 0x0

    if-nez v2, :cond_4

    sget v2, Lkotlinx/coroutines/r;->S:I
    ...
    .line 5
    sget-object v4, Lkotlinx/coroutines/r;->U:Lkotlinx/coroutines/r;

    invoke-virtual {v4, v1, v2}, Lkotlinx/coroutines/r;->K(Ljava/lang/Class;Ljava/util/concurrent/ExecutorService;)Z
    ...
    invoke-direct {v4}, Lkotlinx/coroutines/r;->J()I
...
.method private final declared-synchronized I()Ljava/util/concurrent/Executor;
    ...
    :cond_0
    invoke-direct {p0}, Lkotlinx/coroutines/r;->H()Ljava/util/concurrent/ExecutorService;

    move-result-object v0

    sput-object v0, Lkotlinx/coroutines/r;->pool:Ljava/util/concurrent/Executor;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private final J()I
    ...
    .line 1
    sget v0, Lkotlinx/coroutines/r;->S:I
    ...
    invoke-static {v0, v2}, Lk/g0/e;->b(II)I
...
# virtual methods
.method public final K(Ljava/lang/Class;Ljava/util/concurrent/ExecutorService;)Z
    .locals 4
    ...
    .line 1
    sget-object v0, Lkotlinx/coroutines/r$b;->S:Lkotlinx/coroutines/r$b;
...
.method public dispatch(Lk/z/g;Ljava/lang/Runnable;)V
    ...
    :cond_0
    invoke-direct {p0}, Lkotlinx/coroutines/r;->I()Ljava/util/concurrent/Executor;
    ...
    invoke-interface {v0, p2}, Lkotlinx/coroutines/f2;->b(Ljava/lang/Runnable;)Ljava/lang/Runnable;
    ...
    .line 3
    :cond_2
    sget-object p1, Lkotlinx/coroutines/n0;->Y:Lkotlinx/coroutines/n0;

    invoke-virtual {p1, p2}, Lkotlinx/coroutines/z0;->l0(Ljava/lang/Runnable;)V
