...
.method private connectTls(Lokhttp3/internal/connection/ConnectionSpecSelector;)V
    ...
    .line 31
    invoke-static {v1}, Lm/n;->m(Ljava/net/Socket;)Lm/v;
...
.method private createTunnel(IILokhttp3/Request;Lokhttp3/HttpUrl;)Lokhttp3/Request;
    ...
    invoke-direct {v0, v3, v3, v1, v2}, Lokhttp3/internal/http1/Http1Codec;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/StreamAllocation;Lm/e;Lm/d;)V

    .line 3
    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->source:Lm/e;

    invoke-interface {v1}, Lm/v;->timeout()Lm/w;
    ...
    invoke-virtual {v1, v4, v5, v2}, Lm/w;->timeout(JLjava/util/concurrent/TimeUnit;)Lm/w;

    .line 4
    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lm/d;

    invoke-interface {v1}, Lm/u;->timeout()Lm/w;
    ...
    .line 11
    :cond_0
    invoke-virtual {v0, v1, v2}, Lokhttp3/internal/http1/Http1Codec;->newFixedLengthSource(J)Lm/v;
    ...
    invoke-static {v0, v1, v2}, Lokhttp3/internal/Util;->skipAll(Lm/v;ILjava/util/concurrent/TimeUnit;)Z
    ...
    invoke-interface {p1}, Lm/e;->c()Lm/c;

    move-result-object p1

    invoke-virtual {p1}, Lm/c;->v()Z
    ...
    invoke-interface {p1}, Lm/d;->c()Lm/c;
...
.method public newCodec(Lokhttp3/OkHttpClient;Lokhttp3/Interceptor$Chain;Lokhttp3/internal/connection/StreamAllocation;)Lokhttp3/internal/http/HttpCodec;
    ...
    invoke-virtual {v0, v1, v2, v3}, Lm/w;->timeout(JLjava/util/concurrent/TimeUnit;)Lm/w;
    ...
    invoke-virtual {v0, v1, v2, p2}, Lm/w;->timeout(JLjava/util/concurrent/TimeUnit;)Lm/w;
    ...
    invoke-direct {p2, p1, p3, v0, v1}, Lokhttp3/internal/http1/Http1Codec;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/StreamAllocation;Lm/e;Lm/d;)V
...
.method public newWebSocketStreams(Lokhttp3/internal/connection/StreamAllocation;)Lokhttp3/internal/ws/RealWebSocket$Streams;
    ...
    invoke-direct/range {v0 .. v5}, Lokhttp3/internal/connection/RealConnection$1;-><init>(Lokhttp3/internal/connection/RealConnection;ZLm/e;Lm/d;Lokhttp3/internal/connection/StreamAllocation;)V
