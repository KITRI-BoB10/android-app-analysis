...
.method public static f(Ljava/util/Map;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 1
    invoke-static {p0, p1}, Lk/x/c0;->a(Ljava/util/Map;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static varargs g([Lk/m;)Ljava/util/HashMap;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:",
    ...
    invoke-static {v0, p0}, Lk/x/e0;->j(Ljava/util/Map;[Lk/m;)V
...
.method public static final h(Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 2
    :cond_0
    invoke-static {p0}, Lk/x/d0;->d(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final j(Ljava/util/Map;[Lk/m;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:",
    ...
    invoke-virtual {v2}, Lk/m;->a()Ljava/lang/Object;

    move-result-object v3

    invoke-virtual {v2}, Lk/m;->b()Ljava/lang/Object;
...
.method public static k(Ljava/lang/Iterable;)Ljava/util/Map;
    ...
    invoke-static {p0, v1}, Lk/x/e0;->l(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p0}, Lk/x/d0;->c(Lk/m;)Ljava/util/Map;
    ...
    invoke-static {p0, v0}, Lk/x/e0;->l(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;

    invoke-static {v0}, Lk/x/e0;->h(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final l(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 1
    invoke-static {p1, p0}, Lk/x/e0;->i(Ljava/util/Map;Ljava/lang/Iterable;)V
