.class public final Lcom/linecorp/linesdk/k/d;
...
.method public static b(Landroid/net/Uri;Ljava/util/Map;)Landroid/net/Uri;
    ...
    .line 1
    invoke-static {p0, v0}, Lcom/linecorp/linesdk/k/d;->f(Landroid/net/Uri;[Ljava/lang/String;)Landroid/net/Uri$Builder;

    move-result-object p0

    invoke-static {p0, p1}, Lcom/linecorp/linesdk/k/d;->a(Landroid/net/Uri$Builder;Ljava/util/Map;)Landroid/net/Uri$Builder;
...
.method public static c(Ljava/lang/String;Ljava/util/Map;)Landroid/net/Uri;
    ...
    invoke-static {p0, p1}, Lcom/linecorp/linesdk/k/d;->b(Landroid/net/Uri;Ljava/util/Map;)Landroid/net/Uri;
...
.method public static varargs e(Landroid/net/Uri;[Ljava/lang/String;)Landroid/net/Uri;
    ...
    .line 1
    invoke-static {p0, p1}, Lcom/linecorp/linesdk/k/d;->f(Landroid/net/Uri;[Ljava/lang/String;)Landroid/net/Uri$Builder;
