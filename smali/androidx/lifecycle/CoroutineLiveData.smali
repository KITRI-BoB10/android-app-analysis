...
# direct methods
.method public constructor <init>(Lk/z/g;JLk/c0/c/p;)V
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v0}, Lkotlinx/coroutines/c2;->a(Lkotlinx/coroutines/l1;)Lkotlinx/coroutines/s;
    ...
    invoke-virtual {v1}, Lkotlinx/coroutines/v1;->A()Lkotlinx/coroutines/v1;

    move-result-object v1

    invoke-virtual {v1, p1}, Lk/z/a;->plus(Lk/z/g;)Lk/z/g;

    move-result-object p1

    invoke-interface {p1, v0}, Lk/z/g;->plus(Lk/z/g;)Lk/z/g;
    ...
    .line 8
    invoke-direct/range {v0 .. v6}, Landroidx/lifecycle/BlockRunner;-><init>(Landroidx/lifecycle/CoroutineLiveData;Lk/c0/c/p;JLkotlinx/coroutines/g0;Lk/c0/c/a;)V
...
.method public synthetic constructor <init>(Lk/z/g;JLk/c0/c/p;ILk/c0/d/g;)V
    .locals 0
    ...
    .line 2
    :cond_1
    invoke-direct {p0, p1, p2, p3, p4}, Landroidx/lifecycle/CoroutineLiveData;-><init>(Lk/z/g;JLk/c0/c/p;)V
...
# virtual methods
.method public final clearSource$lifecycle_livedata_ktx_release(Lk/z/d;)Ljava/lang/Object;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0, p1}, Landroidx/lifecycle/CoroutineLiveData$clearSource$1;-><init>(Landroidx/lifecycle/CoroutineLiveData;Lk/z/d;)V
    ...
    invoke-virtual {p1, v0}, Landroidx/lifecycle/EmittedSource;->disposeNow(Lk/z/d;)Ljava/lang/Object;
...
.method public final emitSource$lifecycle_livedata_ktx_release(Landroidx/lifecycle/LiveData;Lk/z/d;)Ljava/lang/Object;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0, p2}, Landroidx/lifecycle/CoroutineLiveData$emitSource$1;-><init>(Landroidx/lifecycle/CoroutineLiveData;Lk/z/d;)V
    ...
    invoke-virtual {p0, v0}, Landroidx/lifecycle/CoroutineLiveData;->clearSource$lifecycle_livedata_ktx_release(Lk/z/d;)Ljava/lang/Object;
    ...
    invoke-static {p1, p2, v0}, Landroidx/lifecycle/CoroutineLiveDataKt;->addDisposableSource(Landroidx/lifecycle/MediatorLiveData;Landroidx/lifecycle/LiveData;Lk/z/d;)Ljava/lang/Object;
