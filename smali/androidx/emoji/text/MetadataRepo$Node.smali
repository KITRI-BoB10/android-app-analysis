.class Landroidx/emoji/text/MetadataRepo$Node;
...
.field private mData:Landroidx/emoji/text/EmojiMetadata;
...
.method private constructor <init>()V
    ...
    .line 1
    invoke-direct {p0, v0}, Landroidx/emoji/text/MetadataRepo$Node;-><init>(I)V
...
# virtual methods
.method get(I)Landroidx/emoji/text/MetadataRepo$Node;
    .locals 1

    .line 1
    iget-object v0, p0, Landroidx/emoji/text/MetadataRepo$Node;->mChildren:Landroid/util/SparseArray;
    ...
    check-cast p1, Landroidx/emoji/text/MetadataRepo$Node;

    :goto_0
    return-object p1
.end method

.method final getData()Landroidx/emoji/text/EmojiMetadata;
    .locals 1

    .line 1
    iget-object v0, p0, Landroidx/emoji/text/MetadataRepo$Node;->mData:Landroidx/emoji/text/EmojiMetadata;

    return-object v0
.end method

.method put(Landroidx/emoji/text/EmojiMetadata;II)V
    .locals 3
    ...
    invoke-virtual {p0, v0}, Landroidx/emoji/text/MetadataRepo$Node;->get(I)Landroidx/emoji/text/MetadataRepo$Node;
