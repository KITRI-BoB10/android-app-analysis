...
.field private mService:Ld/a/a/c;

.field private final mSessionBinder:Ld/a/a/a;
...
.method public constructor <init>(Landroidx/browser/customtabs/CustomTabsSessionToken;)V
    ...
    iput-object p1, p0, Landroidx/browser/customtabs/PostMessageServiceConnection;->mSessionBinder:Ld/a/a/a;
...
.method public final notifyMessageChannelReady(Landroid/os/Bundle;)Z
    ...
    .line 1
    iget-object v0, p0, Landroidx/browser/customtabs/PostMessageServiceConnection;->mService:Ld/a/a/c;
    ...
    .line 3
    :try_start_0
    iget-object v2, p0, Landroidx/browser/customtabs/PostMessageServiceConnection;->mService:Ld/a/a/c;

    iget-object v3, p0, Landroidx/browser/customtabs/PostMessageServiceConnection;->mSessionBinder:Ld/a/a/a;

    invoke-interface {v2, v3, p1}, Ld/a/a/c;->onMessageChannelReady(Ld/a/a/a;Landroid/os/Bundle;)V
    :try_end_0
...
.method public final onServiceConnected(Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    .line 1
    invoke-static {p2}, Ld/a/a/c$a;->asInterface(Landroid/os/IBinder;)Ld/a/a/c;

    move-result-object p1

    iput-object p1, p0, Landroidx/browser/customtabs/PostMessageServiceConnection;->mService:Ld/a/a/c;
...
.method public final postMessage(Ljava/lang/String;Landroid/os/Bundle;)Z
    ...
    invoke-interface {v2, v3, p1, p2}, Ld/a/a/c;->onPostMessage(Ld/a/a/a;Ljava/lang/String;Landroid/os/Bundle;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
