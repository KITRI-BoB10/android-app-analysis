...
.method static synthetic access$000(Lorg/json/JSONObject;)Le/b$a;
    .locals 0

    .line 1
    invoke-static {p0}, Lcom/facebook/applinks/FacebookAppLinkResolver;->getAndroidTargetFromJson(Lorg/json/JSONObject;)Le/b$a;
...
.method private static getAndroidTargetFromJson(Lorg/json/JSONObject;)Le/b$a;
    .locals 5
    ...
    invoke-direct {p0, v0, v2, v1, v3}, Le/b$a;-><init>(Ljava/lang/String;Ljava/lang/String;Landroid/net/Uri;Ljava/lang/String;)V
...
# virtual methods
.method public getAppLinkFromUrlInBackground(Landroid/net/Uri;)Le/h;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 3
    invoke-virtual {p0, v0}, Lcom/facebook/applinks/FacebookAppLinkResolver;->getAppLinkFromUrlsInBackground(Ljava/util/List;)Le/h;
    ...
    invoke-virtual {v0, v1}, Le/h;->v(Le/f;)Le/h;
...
.method public getAppLinkFromUrlsInBackground(Ljava/util/List;)Le/h;
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 15
    invoke-static {v0}, Le/h;->o(Ljava/lang/Object;)Le/h;
    ...
    invoke-direct {v8, p0, p1, v0, v1}, Lcom/facebook/applinks/FacebookAppLinkResolver$2;-><init>(Lcom/facebook/applinks/FacebookAppLinkResolver;Le/h$g;Ljava/util/Map;Ljava/util/HashSet;)V
