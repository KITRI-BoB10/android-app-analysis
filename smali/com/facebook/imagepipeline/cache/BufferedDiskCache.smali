...
.method private containsAsync(Lcom/facebook/cache/common/CacheKey;)Le/h;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v1, v0}, Le/h;->c(Ljava/util/concurrent/Callable;Ljava/util/concurrent/Executor;)Le/h;
    ...
    .line 4
    invoke-static {v0}, Le/h;->n(Ljava/lang/Exception;)Le/h;
...
.method private foundPinnedImage(Lcom/facebook/cache/common/CacheKey;Lcom/facebook/imagepipeline/image/EncodedImage;)Le/h;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 3
    invoke-static {p2}, Le/h;->o(Ljava/lang/Object;)Le/h;
...
.method private getAsync(Lcom/facebook/cache/common/CacheKey;Ljava/util/concurrent/atomic/AtomicBoolean;)Le/h;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v1, p2}, Le/h;->c(Ljava/util/concurrent/Callable;Ljava/util/concurrent/Executor;)Le/h;
    ...
    .line 4
    invoke-static {p2}, Le/h;->n(Ljava/lang/Exception;)Le/h;
...
.method public contains(Lcom/facebook/cache/common/CacheKey;)Le/h;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 3
    :cond_0
    invoke-direct {p0, p1}, Lcom/facebook/imagepipeline/cache/BufferedDiskCache;->containsAsync(Lcom/facebook/cache/common/CacheKey;)Le/h;
...
.method public get(Lcom/facebook/cache/common/CacheKey;Ljava/util/concurrent/atomic/AtomicBoolean;)Le/h;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 4
    invoke-direct {p0, p1, v0}, Lcom/facebook/imagepipeline/cache/BufferedDiskCache;->foundPinnedImage(Lcom/facebook/cache/common/CacheKey;Lcom/facebook/imagepipeline/image/EncodedImage;)Le/h;
    ...
    :cond_2
    :try_start_1
    invoke-direct {p0, p1, p2}, Lcom/facebook/imagepipeline/cache/BufferedDiskCache;->getAsync(Lcom/facebook/cache/common/CacheKey;Ljava/util/concurrent/atomic/AtomicBoolean;)Le/h;
...
.method public remove(Lcom/facebook/cache/common/CacheKey;)Le/h;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
