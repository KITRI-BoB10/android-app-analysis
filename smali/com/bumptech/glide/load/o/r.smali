...
.method public constructor <init>(Landroidx/core/util/Pools$Pool;)V
    ...
    invoke-direct {p0, p1, v0}, Lcom/bumptech/glide/load/o/r;-><init>(Landroidx/core/util/Pools$Pool;Lcom/bumptech/glide/load/o/r$c;)V

    return-void
.end method

.method constructor <init>(Landroidx/core/util/Pools$Pool;Lcom/bumptech/glide/load/o/r$c;)V
    .locals 1
    .param p1    # Landroidx/core/util/Pools$Pool;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    .param p2    # Lcom/bumptech/glide/load/o/r$c;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    ...
    .line 5
    iput-object p1, p0, Lcom/bumptech/glide/load/o/r;->d:Landroidx/core/util/Pools$Pool;
...
.method private c(Lcom/bumptech/glide/load/o/r$b;)Lcom/bumptech/glide/load/o/n;
    .locals 0
    .param p1    # Lcom/bumptech/glide/load/o/r$b;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    .annotation build Landroidx/annotation/NonNull;
    ...
    invoke-interface {p1, p0}, Lcom/bumptech/glide/load/o/o;->c(Lcom/bumptech/glide/load/o/r;)Lcom/bumptech/glide/load/o/n;
...
.method private h(Lcom/bumptech/glide/load/o/r$b;)Lcom/bumptech/glide/load/o/o;
    .locals 0
    .param p1    # Lcom/bumptech/glide/load/o/r$b;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method public declared-synchronized d(Ljava/lang/Class;Ljava/lang/Class;)Lcom/bumptech/glide/load/o/n;
    ...
    iget-object p2, p0, Lcom/bumptech/glide/load/o/r;->d:Landroidx/core/util/Pools$Pool;

    invoke-virtual {p1, v0, p2}, Lcom/bumptech/glide/load/o/r$c;->a(Ljava/util/List;Landroidx/core/util/Pools$Pool;)Lcom/bumptech/glide/load/o/q;
...
.method declared-synchronized i(Ljava/lang/Class;Ljava/lang/Class;)Ljava/util/List;
    ...
    .line 4
    invoke-virtual {v2, p1, p2}, Lcom/bumptech/glide/load/o/r$b;->b(Ljava/lang/Class;Ljava/lang/Class;)Z
    ...
    .line 6
    invoke-direct {p0, v2}, Lcom/bumptech/glide/load/o/r;->h(Lcom/bumptech/glide/load/o/r$b;)Lcom/bumptech/glide/load/o/o;
...
.method declared-synchronized j(Ljava/lang/Class;Ljava/lang/Class;Lcom/bumptech/glide/load/o/o;)Ljava/util/List;
    .locals 1
    .param p1    # Ljava/lang/Class;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    .line 1
    :try_start_0
    invoke-virtual {p0, p1, p2}, Lcom/bumptech/glide/load/o/r;->i(Ljava/lang/Class;Ljava/lang/Class;)Ljava/util/List;

    move-result-object v0

    .line 2
    invoke-virtual {p0, p1, p2, p3}, Lcom/bumptech/glide/load/o/r;->b(Ljava/lang/Class;Ljava/lang/Class;Lcom/bumptech/glide/load/o/o;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
